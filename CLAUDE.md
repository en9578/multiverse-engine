...
```bash
# Java backend (dev mode, H2 in-memory, zero external deps)
...
**Frontend**: `index.html` is a static landing page (presentation only). Real React + Three.js app is not yet built.
